...
void init_lighting() {
	...
	void* icon_pixel_data = stbi_load(mask_filename, &mask_width, &mask_height, NULL, 4);
	lighting_mask = SDL_CreateRGBSurfaceFrom(icon_pixel_data, mask_width, mask_height, 32, 4*mask_width,
